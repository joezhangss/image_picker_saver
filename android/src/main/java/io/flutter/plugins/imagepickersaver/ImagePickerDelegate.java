...
//        Log.e("保存图片", "2222222222保存图片日志。。。fileData==="+fileData);
//        String filePath = CapturePhotoUtils.insertImage(activity.getContentResolver(), fileData, title, desctiption);
        String filePath = MediaStore.Images.Media.insertImage(activity.getContentResolver(), bitmap, title, desctiption);
//        Log.e("保存图片", "111111111111保存图片日志。。。 filePath=="+filePath);
...
//        Log.e("保存图片", "44444444保存图片日志。。。 "+imagePath);
        pendingResult.success(imagePath);
//        Log.e("保存图片", "55555保存图片日志。。。 ");
